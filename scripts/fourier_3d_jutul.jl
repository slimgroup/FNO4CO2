...
conc_path = datadir("training-data", "jutul_conc_gridspacing15.0.mat")
...
if ~isfile(conc_path)
    run(`wget https://www.dropbox.com/s/1ccq3yl9ejprsgj/'
        'jutul_conc_gridspacing15.0.mat -q -O $conc_path`)
end

perm = log.(matread(perm_path)["perm"] * 9.869232667160130f-13 * 1f-3);
