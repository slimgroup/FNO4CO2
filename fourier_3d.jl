...
function SpectralConv3d_fast(in_channels::Integer, out_channels::Integer, modes1::Integer, modes2::Integer, modes3::Integer)
    ...
    return SpectralConv2d{Complex{Float32}, 4}(weights1, weights2, weights3, weights4)
end
...
function SimpleBlock3d(modes1::Integer, modes2::Integer, modes3::Integer, width::Integer)
    block = SimpleBlock3d(
        Conv((1, 1), 4=>width),
        SpectralConv2d(width, width, modes1, modes2, modes3),
        SpectralConv2d(width, width, modes1, modes2, modes3),
        SpectralConv2d(width, width, modes1, modes2, modes3),
        SpectralConv2d(width, width, modes1, modes2, modes3),
...
prog = Progress(length(train_data) * args.epochs)
