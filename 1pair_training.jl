...
for ep = 1:epochs
    ...
    grads = gradient(w) do
        out = decode(y_normalizer,NN(x1))
        y_n = decode(y_normalizer,y1)
...
BSON.@save "2phasenet_1pair$epochs.bson" NN w batch_size Loss modes width learning_rate epochs gamma step_size
