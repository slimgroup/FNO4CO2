...
BSON.@load "Darcynet_100.bson" NN w batch_size Loss modes width learning_rate epochs gamma step_size
...
subplot(4,3,4);
title("predict 1")
imshow(y_predict_1,vmin=0f0,vmax=maximum(y_train_))
subplot(4,3,5);
title("predict 2")
imshow(y_predict_2,vmin=0f0,vmax=maximum(y_train_))
subplot(4,3,6);
title("predict 3")
imshow(y_predict_3,vmin=0f0,vmax=maximum(y_train_))
subplot(4,3,7);
title("true 1")
imshow(y_test_1,vmin=0f0,vmax=maximum(y_train_))
subplot(4,3,8);
title("true 2")
imshow(y_test_2,vmin=0f0,vmax=maximum(y_train_))
subplot(4,3,9);
title("true 3")
imshow(y_test_3,vmin=0f0,vmax=maximum(y_train_))
subplot(4,3,10);
title("30*diff1")
imshow(30*abs.(y_test_1-y_predict_1),vmin=0f0,vmax=maximum(y_train_))
subplot(4,3,11);
title("30*diff2")
imshow(30*abs.(y_test_2-y_predict_2),vmin=0f0,vmax=maximum(y_train_))
subplot(4,3,12);
title("30*diff3")
imshow(20*abs.(y_test_3-y_predict_3),vmin=0f0,vmax=maximum(y_train_))
